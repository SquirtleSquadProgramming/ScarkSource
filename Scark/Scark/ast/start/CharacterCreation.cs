    ...
    public class CC
    {
        ...
        public string[] NewPlayer(bool dev)
        {
            ...
            if (!dev) // TEMPORARY: If user is dev then skip story lines
            {
                ...
                Thread.Sleep(1000);
                Console.WriteLine("\nThe executioner asks if anybody objects to the hanging.");
                Thread.Sleep(1000);
                Console.WriteLine("\nSilence.");
                Thread.Sleep(1000);
                Console.WriteLine("\nAs the executioner moves his hand towards the lever, a voice is heard.");
                Thread.Sleep(1000);
                Console.WriteLine("\n[VOICE] I object!");
                Thread.Sleep(1000);
